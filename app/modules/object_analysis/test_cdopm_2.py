...
if __name__ == '__main__':
    ...
    # Load JSON Data (validation data)
    json_file = "F:/Anfa Backup/E/IBA_8th_sm/FYP/brom_14/borm/object_information/150obj_Places365_7.json"
    ...
    for img_path, label in progress_bar:
        # Only process validation data
        if "val" not in img_path:  # Check if the path is for the validation set
            continue
